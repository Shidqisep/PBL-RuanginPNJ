        ...
        <footer class="bg-white border-t border-gray-200 py-8 shadow-xl">
            <div class="mx-8 px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 gap-5 text-sm">
                    ...
                    <!-- Logo & Tagline -->
                    <div class="flex flex-col lg:flex-row items-center justify-between my-5">
                        <div class="flex flex-col items-center space-x-2 mb-2">
                            <div class="w-full flex items-center justify-start space-x-2 mb-1 px-2">
                                <img src="/img/LOGO PNJ FIX 1.png" alt="Logo" class="w-auto h-10">
                                <span class="text-xl font-bold text-[#171E29]">ruanginPNJ</span>
                            </div>
                    ...
                    <div class="grid lg:grid-cols-3 grid-rows-1 gap-5 pt-6 border-t border-gray-200">
                        <div class>
                            <h3 class="font-bold text-[#171E29] mb-3 text-xs">Jam Kerja</h3>
                            <p class="mb-1 text-xs">Senin-Kamis: 08:00-18:00</p>
                            <p class="mb-1 text-xs">Jumat: 08:00-16:00</p>
                        </div>
                        <div class="md:w-5/6">
                            <h3 class="font-bold text-[#171E29] mb-3 text-xs">Tentang Kami</h3>
                        ...
                        <div class="md:w-5/6">
                            <h3 class="font-bold text-[#171E29] mb-3 text-xs">Alamat</h3>
                    ...
                    <!-- Copyright -->
                    <div class="pt-6 border-t border-gray-200 text-center text-dark-overlay/70 text-xs text-gray-500">
